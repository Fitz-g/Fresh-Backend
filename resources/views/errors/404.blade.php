                    ...
                    <div class="row g-0">
                        <div class="col col-xl-5">
                            <div class="card-body p-4">
                                <h1 class="display-1"><span class="text-dark font-weight-bolder">4</span><span
                                        class="text-dark font-weight-bolder">0</span><span
                                        class="text-dark font-weight-bolder">4</span></h1>
                                ...
                                <div class="mt-5"> <a href="{{ route('home') }}"
                                        class="btn btn-primary btn-lg px-md-5 radius-30">Accueil</a>
