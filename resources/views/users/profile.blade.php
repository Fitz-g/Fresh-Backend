                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img
                                    src="{{ ($user->avatar_path) ? asset($user->avatar_path) : asset('uploaded/avatar.png') }}"
                                    alt="user-profile" class="rounded-circle p-1 bg-primary" width="110"
                                    style="height: 105px;">
                                <div class="mt-3">
                                    ...
                                    <form action="{{ route('update.avatar') }}" method="post"
                                        ...
                                        @csrf
                                        <div class="mb-3">
                                            <label for="formFile" class="form-label text-dark">Changer de photo</label>
                                            <input class="form-control" name="file" type="file" id="formFile">
                                            @error('file')
                                            <div class="small text-danger">{{ $message }}</div> @enderror
                                        </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('update.profile') }}" method="post">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input name="phone" type="tel" maxlength="10" minlength="10" class="form-control"
                                               value="{{ $user->phone }}"/>
                                        @error('phone')
                                            <div class="small text-danger">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('update.password') }}" method="post">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
                                                <h6 class="mb-0">Confirmer nouveau mot de passe</h6>
                                            </div>
                                            <div class="col-sm-9 text-secondary">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3"></div>
                                            <div class="col-sm-9 text-secondary">
                                                <button type="submit" class="btn btn-primary px-4">Modifier le mot de passe</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
